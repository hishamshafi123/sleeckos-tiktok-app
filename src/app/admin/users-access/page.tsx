...
const TOOLS = [
  ...
  { key: "accounts", label: "Managed Accounts", desc: "Link/unlink accounts, view post schedules, queues, and history." },
...
const ROLE_DEFAULTS: Record<string, string[]> = {
  admin: ["clip_mixer", "style_studio", "composer", "multiplier", "accounts", "campaigns", "projects", "sourcing", "users_access", "lms"],
  team_lead: ["clip_mixer", "style_studio", "composer", "multiplier", "accounts", "campaigns", "projects", "sourcing", "lms"],
  editor: ["clip_mixer", "style_studio", "composer", "multiplier", "lms"],
  curator: ["campaigns", "projects", "lms", "accounts", "sourcing"],
};
