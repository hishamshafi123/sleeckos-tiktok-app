...
import { previewDistribution } from "@/lib/services/sourcing";

// POST /api/sourcing/links/runs/[id]/preview — { accountCounts, allowReuse } → plan + feasibility
export async function POST(
  ...
  const result = await previewDistribution(id, accountCounts, body.allowReuse === true);
