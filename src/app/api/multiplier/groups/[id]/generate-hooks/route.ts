...
// Body: { count?: number = 15, useCampaignContext?: boolean = true, customPrompt?: string }
export async function POST(
  ...
  try {
    const { count = 15, useCampaignContext = true, customPrompt } = await req.json();
    ...
    console.error("[Multiplier Generate Hooks POST API] Error:", err);
