...
import { LayoutDashboard, Megaphone, Users, BarChart2, CreditCard, Settings, LogOut } from "lucide-react";
import { toast } from "sonner";

const NAV = [
  { href: "/b/dashboard", label: "Dashboard", icon: LayoutDashboard },
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 border-r border-white/5 bg-[#0d0d14] flex flex-col">
      <div className="p-5 border-b border-white/5">
        ...
        <p className="text-xs text-gray-600 mt-2">Brand Portal</p>
      </div>
