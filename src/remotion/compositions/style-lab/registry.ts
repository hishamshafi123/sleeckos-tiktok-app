...
import { isAiTemplateKey, type StyleFamily, type StyleParams } from "../../../lib/style-lab/schema";
 ...
 * templates resolve through IMPORTED_COMPONENTS. AI-generated templates
 * (ai_* keys) are layered styles by construction and resolve through the
 * layered-style comp — their layer stack arrives via input props.
 */
